...
<head>
    ...
    <style>
        ...
        .imgPerfil {
            ...
            object-fit: cover; /* Isso fará com que a imagem seja dimensionada para preencher o espaço mantendo a proporção original */
            margin: 10px;
            background-color: black;
            padding-bottom: 10px;
            border: 1px solid #ddd; /* Adicione uma borda opcional */
    ...
    <div class="container col-md-9 col-sm-11 rounded-0">
        <div class="col-12 rounded p-4 mt-4 d-md-flex gap-5">
            <div class="col-md-4 col-sm-12 d-flex justify-content-center mx-auto align-items-start">
                <div class="px-md-5"></div><img src="assets/recursos/profile/<?= $profile['profile_pic'] ?>" class="img-thumbnail rounded-circle mb-3" style="width:170px;height:170px" alt="...">
                ...
                <div class="d-flex flex-column">
                        ...
                        ?>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#chatbox" onclick="popchat(<?= $profile['id'] ?>)"><i class="bi bi-chat-fill"></i> Mensagens</a></li>
                    ...
                    ?>
                        <div class="d-flex gap-2 align-items-center my-3">
                            ...
                            <a class="btn btn-sm btn-primary <?= count($profile['following']) < 1 ? 'disabled' : '' ?>" data-bs-toggle="modal" data-bs-target="#following_list"><i class="bi bi-person-fill"></i> <?= count($profile['following']) ?> Seguindo</a>
                        ...
                        <div class="d-flex gap-2 align-items-center my-1">
                            ...
                            <?php
                                ...
                                <div class="alert alert-danger" role="alert">
                                    <i class="bi bi-x-octagon-fill"></i> @<?= $profile['username'] ?> bloqueou voce
                                </div>
                            <?php } else if (checarStatusSeguindo($profile['id'])) {
                            ?>
                                <button class="btn btn-sm btn-danger unfollowbtn" data-user-id='<?= $profile['id'] ?>'>Deixar de seguir</button>
        ...
        ?>
            <div class="alert alert-secondary text-center" role="alert">
                <i class="bi bi-x-octagon-fill"></i> Você nao pode ver as postagens
            </div>
        <?php
        ...
        <div class="gallery d-flex flex-wrap gap-2 mb-4">
            ...
            ?>
                ...
                <div class="row imgPerfil">
                     <img class='' src="assets/recursos/posts/<?= $post['post_img'] ?>" loading=lazy class="" alt="...">
                    <audio class='' src="assets/recursos/posts/<?= $post['post_music'] ?>" controls data-bs-toggle="modal" data-bs-target="#postview<?= $post['id'] ?>" class="rounded"></audio>
                    <?php
                    if ($post['post_text']) {
                    ?>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body d-md-flex p-0">
                                <div class="col-md-8 col-sm-12">
                                    <img class='imgPerfil' src="assets/recursos/posts/<?= $post['post_img'] ?>" loading=lazy alt="...">
                                    <audio src="assets/recursos/posts/<?= $post['post_music'] ?>" controls style="max-height:90vh" class="w-100 rounded-start"></audio>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-12 d-flex flex-column">
                                    <div class="d-flex align-items-center p-2 <?= $post['post_text'] ? '' : 'border-bottom' ?>">
                                        <div><img src="assets/recursos/profile/<?= $profile['profile_pic'] ?>" alt="" height="50" width="50" class="rounded-circle border">
                                        </div>
                                        <div>&nbsp;&nbsp;&nbsp;</div>
                                    ...
                                    <div class="flex-fill align-self-stretch overflow-auto" id="comment-section<?= $post['id'] ?>" style="height: 100px;">
                                        ...
                                        if (count($comments) < 1) {
                                        ?>
                                            <p class="p-3 text-center my-2 nce">nenhum comentário</p>
                                        <?php
                                        }
                                        ...
                                        ?>
                                            <div class="d-flex align-items-center p-2">
                                                <div><img src="assets/recursos/profile/<?= $cuser['profile_pic'] ?>" alt="" height="40" width="40" class="rounded-circle border">
                                                </div>
                                                <div>&nbsp;&nbsp;&nbsp;</div>
                                    ...
                                    <?php
                                    if (checarStatusSeguindo($profile['id']) || $profile['id'] == $user['id']) {
                                    ?>
                                        <div class="input-group p-2 border-top">
                                            <input type="text" class="form-control rounded-0 border-0 comment-input" placeholder="Comente algo..." aria-label="Recipient's username" aria-describedby="button-addon2">
                                    ...
                                    ?>
                                        <div class="text-center p-2">
                                            se você quer comentar siga este usuário</div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    foreach ($profile['followers'] as $f) {
                        ...
                        $fbtn = '';
                        if (checarStatusSeguindo($f['follower_id'])) {
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    foreach ($profile['following'] as $f) {
                        ...
                        $fbtn = '';
                        if (checarStatusSeguindo($f['user_id'])) {
                            $fbtn = '<button class="btn btn-sm btn-danger unfollowbtn" data-user-id=' . $fuser['id'] . ' >Unfollow</button>';
